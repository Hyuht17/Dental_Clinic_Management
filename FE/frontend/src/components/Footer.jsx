  ...
  return (
    <div className='md:mx-10'>
      <div className='flex flex-col sm:grid grid-cols-[2fr_1fr_1fr] gap-14 my-10  mt-40 text-sm'>
        ...
        <div>
          <img className='w-48.5' src={assets.logo} alt="" />
          <p className='w-full md:w-2/3 text-gray-600 leading-6'>Răng khỏe – Tâm an – Cuộc sống thăng hoa.</p>
        </div>
        ...
        <div>
          ...
          <ul className='flex flex-col gap-2 text-gray-600'>
            ...
            <li>dentalClinicHust@gmail.com</li>
          </ul>
        </div>
